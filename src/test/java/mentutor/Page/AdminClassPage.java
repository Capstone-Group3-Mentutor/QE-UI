...
public class AdminClassPage extends PageObject {
    ...
    public static final By ADMIN_CLASS_KEBAB_TESTING = By.cssSelector(".flex:nth-child(4) path");
    public static final By CLASS_TESTING_EDIT = By.cssSelector(".flex:nth-child(4) #edit-click");
    ...
    public static final By CLASS_TESTING_STATUS = By.cssSelector(".flex:nth-child(4) > .w-\\[17\\%\\]");
    ...
    public static final By EDIT_CLASS_EDITED = By.cssSelector(".flex:nth-child(4) #edit-click");
    public static final By CLASS_EDITED_NAME = By.cssSelector("div.flex:nth-child(4) > p:nth-child(2)");
    public static final By CLASS_EDIT_STATUS = By.cssSelector("div.flex:nth-child(4) > p:nth-child(4)");
    public static final By BUTTON_ADD_CLASS = By.id("btn-addClass");
    public static final By ADMIN_CLASS_KEBAB_DELETED = By.cssSelector(".flex:nth-child(3) #icon-options path");
    public static final By DELETE_CLASS_BUTTON = By.cssSelector(".flex:nth-child(3) a");
